  ...
  return (
    ...
    {isLoading && (
      <div className="fixed inset-0 z-50 bg-white bg-opacity-80 flex flex-col items-center justify-center">
        <img src="/Branches_2.0_Logo.png" className="w-12 h-12 mb-4 animate-bounce" />
...
<section
  ...
  style={{
    backgroundImage: "url('/PFbanner.png')",
...
onClick={() => {
  ...
  if (!isLoggedIn) {
    ...
    setTimeout(() => {
      ...
      alert("사용자 정보를 불러옵니다. (가상)");
      // ✅ 여기에 나중에 navigate('/portfolio') 등 추가하면 됨
    }, 2000); // 2초 가상 대기
  }
}}
>
